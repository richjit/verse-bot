...
WHAT_IS_VERSE = (
    ...
    "Run marketing campaigns · Manage customer support · Research competitors · Handle business operations "
    "· Automate workflows across apps · Manage crypto-native operations · Personal assistants · "
